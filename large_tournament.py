...
test_df.to_csv('/scratch/c1304586/large_test_data.csv')
cleaned_test_df = clean_test_df(test_df)
cleaned_test_df.to_csv('/scratch/c1304586/large_cleaned_test_data.csv')
training_df = create_large_df(cleaned_test_df)
training_df.to_csv('/scratch/c1304586/large_training_data.csv')
